...
namespace RoboticsManagement.Migrations
{
    ...
    [Migration("20210518114831_createdContactmessages")]
    partial class createdContactmessages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoboticsManagement.Models.ComplaintForm.FormModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoboticsManagement.Models.Home.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoboticsManagement.Models.InvoiceData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoboticsManagement.Models.Notifications.AdminNotifications", b =>
                {
            ...
            modelBuilder.Entity("RoboticsManagement.Models.Notifications.ClientNotifications", b =>
                {
                    b.Property<int>("NotiId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoboticsManagement.Models.Notifications.EmployeeNotifications", b =>
                {
                    b.Property<int>("NotiId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RoboticsManagement.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoboticsManagement.Models.TaskForEmployee", b =>
                {
                    b.HasOne("RoboticsManagement.Models.ApplicationUser", "Employee")
                        .WithMany("TaskForEmployee")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoboticsManagement.Models.EmployeeTask", "EmployeeTask")
                        .WithMany("TaskForEmployee")
